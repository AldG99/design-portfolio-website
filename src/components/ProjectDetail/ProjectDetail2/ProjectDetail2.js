      ...
      <div className="container">
        ...
        <section className="project-detail__section">
          ...
          <div className="project-detail__understanding">
            ...
            <div className="understanding-image">
              <img
                src={project2.research.researchImage}
        ...
        <section className="project-detail__section">
          ...
          <div className="project-detail__personas">
            <div
              ...
              data-count={project2.userProfiles.length}
            >
          ...
          <div className="project-detail__journey-maps">
            ...
            <div className="journey-maps-vertical">
              {project2.userJourneyMap.map((journey, index) => (
        ...
        <section className="project-detail__section">
          ...
          <div className="design-section">
            ...
            <div className="design-image">
              <img
                src={project2.informationArchitecture.sitemap.sitemapImage}
                alt="Mapa del sitio"
                onClick={() =>
                  openImageModal(
                    project2.informationArchitecture.sitemap.sitemapImage
                  )
                }
          ...
          <div className="design-section">
            ...
            <div className="design-image">
              <img
                ...
                onClick={() =>
                  openImageModal(
                    project2.informationArchitecture.userFlow.userFlowImage
                  )
                }
                className="clickable-image"
              />
        ...
        <section className="project-detail__section">
          <div className="design-section">
            ...
            <div
              ...
              data-count={
                project2.wireframing.paperWireframes.paperWireframesImage.length
              }
            >
              {project2.wireframing.paperWireframes.paperWireframesImage.map(
                (image, index) => (
                  <img
                    key={index}
                    src={image}
          ...
          <div className="design-section">
            ...
            <div className="design-image">
              <img
                src={
                  project2.wireframing.digitalWireframes.digitalWireframesImage
                }
        ...
        <section className="project-detail__section">
          <div className="design-section">
            ...
            <p className="design-text">
              {project2.prototyping.lowFidelity.description}
            </p>
            <div className="design-image">
              <img
                src={project2.prototyping.lowFidelity.prototypeImage}
                alt="Prototipo de baja fidelidad"
              />
            </div>
            <div className="prototype-link">
              <a
                href={project2.prototyping.lowFidelity.prototypeUrl}
                target="_blank"
        ...
        <section className="project-detail__section">
            ...
            <div className="usability-details">
              <div className="detail-item">
                ...
                <span className="detail-value">
                  {project2.usabilityStudy.parameters.type}
                </span>
              </div>
              <div className="detail-item">
                <span className="detail-label">Ubicación:</span>
                <span className="detail-value">
                  {project2.usabilityStudy.parameters.location}
                </span>
              </div>
              <div className="detail-item">
                <span className="detail-label">Participantes:</span>
                <span className="detail-value">
                  {project2.usabilityStudy.parameters.participants}
                </span>
              </div>
              <div className="detail-item">
                <span className="detail-label">Duración:</span>
                <span className="detail-value">
                  {project2.usabilityStudy.parameters.time}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="findings-list">
            {project2.usabilityStudy.keyFindings.map((finding, index) => (
        ...
        <section className="project-detail__section">
          ...
          <div className="screen-variations">
            ...
            <p className="strategy-description">
              {project2.visualDesign.responsiveDesign.strategy}
            </p>
            <ul className="strategy-decisions">
              {project2.visualDesign.responsiveDesign.keyDecisions.map(
                (decision, index) => (
          ...
          <div className="design-section">
            ...
            <div className="high-fidelity-section">
              {project2.visualDesign.highFidelity.description.map(
                (text, index) => (
              ...
              <div className="high-fidelity-image">
                <img
                  src={project2.visualDesign.highFidelity.highFidelityImage}
          ...
          <ol className="accessibility-list">
            {project2.visualDesign.accessibility.considerations.map(
              (consideration, index) => (
        ...
        <section className="project-detail__section">
          ...
          <div className="results-section">
            ...
            <p className="conclusion-text">{project2.conclusion.summary}</p>
          </div>

          <div className="results-section">
            <h3 className="subsection-title">IMPACTO</h3>
            <p className="impact-text">{project2.conclusion.impact}</p>
          </div>

          <div className="results-section">
            <h3 className="subsection-title">LO QUE APRENDÍ</h3>
            <p className="learnings-text">{project2.conclusion.learnings}</p>

            <div className="lessons-grid">
              <div className="lessons-section">
                <h4 className="lessons-title">Lecciones profesionales</h4>
                <ul className="lessons-list">
                  {project2.conclusion.professionalLessons.map(
                    (lesson, index) => (
              ...
              <div className="lessons-section">
                ...
                <ul className="lessons-list">
                  {project2.conclusion.personalLessons.map((lesson, index) => (
                    <li key={index} className="lesson-item">
                      {lesson}
                    </li>
                  ))}
          ...
          <div className="results-section">
            ...
            <ol className="next-steps-list">
              {project2.conclusion.nextSteps.map((step, index) => (
