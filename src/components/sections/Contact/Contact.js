...
const Contact = () => {
  ...
  const handleSubmit = e => {
    ...
    // Simular envío exitoso (aquí se conectaría con un backend real)
    setFormStatus({
      message:
  ...
  return (
    <section id="contact" className="contact">
      <div className="container">
        <h2 ref={titleRef} className="section__title contact__title">
          Contacto
        </h2>
        ...
        <div className="contact__container">
          <div ref={infoRef} className="contact__info">
            ...
            <p className="contact__info-text">
              Estoy interesado en oportunidades freelance y proyectos
              desafiantes. Si tienes alguna pregunta o propuesta, no dudes en
              contactarme utilizando el formulario o a través de mis datos de
              contacto.
            </p>
            ...
            <div className="contact__info-items">
              <div className="contact__info-item">
                ...
                <div className="contact__info-content">
                  <h4 className="contact__info-label">Teléfono</h4>
                  <a href="tel:+11234567890" className="contact__info-value">
                    +1 (123) 456-7890
                  </a>
                </div>
              </div>
              ...
              <div className="contact__info-item">
                ...
                <div className="contact__info-content">
                  ...
                  <span className="contact__info-value">Ciudad, País</span>
                </div>
              </div>
            </div>

            <div className="contact__social">
              <h4 className="contact__social-title">Sígueme</h4>
